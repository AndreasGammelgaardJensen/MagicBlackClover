...
public partial class AppShell : Shell
{
    ...
    void RegisterRoutes()
    {
		Routes.Add("collectiondetails", typeof(CollectionDetailPage));
		Routes.Add("scancollections", typeof(ScanCollectionPage));
		Routes.Add("cardetails", typeof(CardDetailPage));
